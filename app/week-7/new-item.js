...
export default function NewItem(props) {
    ...
    return (
        <form className='grid grid-cols-2 gap-2 grid-rows-3 h-44 w-max bg-amber-50 items-center pr-1.5 pl-1.5 pt-2 pb-2' onSubmit={(event) => props.onAddItem({name, category, quantity})}>
