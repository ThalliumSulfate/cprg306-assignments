...
export default function NewItem() {
    ...
    return (
        <form className='grid grid-cols-2 gap-2 grid-rows-3 h-44 bg-amber-50 items-center pr-1.5 pl-1.5 pt-2 pb-2 w-1/5' onSubmit={handleSubmit}>
            <input className='w-full h-fit col-span-2 row-start-1 p-3 rounded-lg border' placeholder='Item name' type='text' required value={name} onChange={(event) => setName(event.target.value)} />
